...
class DAGCircuit:
    ...
    def __init__(self):
        ...
        self.add_basis_element("c3x", 4, 0, 0)
        self.add_basis_element("c4x", 5, 0, 0)
        self.add_basis_element("c5x", 6, 0, 0)
        self.add_basis_element("ccu1", 3, 0, 0)
        self.add_basis_element("c3u1", 4, 0, 0)
        self.add_basis_element("c4u1", 5, 0, 0)
        self.add_basis_element("c5u1", 6, 0, 0)
